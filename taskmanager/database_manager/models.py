...
class Dialect(models.Model):
    ...
    driver = models.CharField('Драйвер', max_length=100, null=True, blank=True)
...
class Connection(models.Model):
    name = models.CharField('Название', max_length=100, null=True, blank=True)
    dialect = models.ForeignKey(Dialect, on_delete=models.CASCADE, null=True, blank=True)
    ...
    tables = models.JSONField('Таблицы в JSON', default=dict, null=True, blank=True)
